  ...
  const contactInfo = [
    {
      ...
      title: "Email Us",
      content: "support@titan-pomade.com",
    ...
    },
    {
      ...
      description: "Monday to Friday from 9AM to 5PM EST"
    },
    {
      icon: <MapPin className="h-6 w-6" />,
      title: "Visit Us",
      content: "123 Developer Street, San Francisco, CA 94103",
                  ...
                  <form className="space-y-6">
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="relative">
                        ...
                        <Textarea id="message" placeholder="How can we help you?" className="pl-10" rows={5} />
                      </div>
                    </div>
